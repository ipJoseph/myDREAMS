...
# TEMPORARY grace-period override (2026-04-24, expires 21:00 UTC):
# MLS Grid granted a grace window that lifts rate AND data limits. During
# the window we set MIN_REQUEST_INTERVAL=0.05 (~20 rps ceiling) and bump
# hourly/daily caps 50x so the cross-process throttle doesn't gate the
# parallel drain. MUST be reverted to (3.0 / 3000 / 20000) at ramp-down.
