...
echo "=========================================="
echo ""
echo "  0. Install system packages:"
echo "     sudo apt install wl-clipboard python3-venv nodejs npm"
echo ""
echo "  1. Create Python venv and install dependencies:"
...
echo ""
echo "  3. Add shell aliases to ~/.bashrc:"
echo "     alias clipimg=\"~/myDREAMS/scripts/clip-image.sh\""
echo "     source ~/.bashrc"
echo ""
echo "  4. Configure GNOME Online Accounts (Google Drive):"
echo "     env XDG_CURRENT_DESKTOP=GNOME gnome-control-center online-accounts"
echo ""
echo "  5. Verify crontab is set:"
echo "     crontab -l"
